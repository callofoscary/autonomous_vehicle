...
def main():
    ...
    while (not rospy.is_shutdown()):
        ...
        print('control actions',"delta", -1*Controller.uPred[0,0],"dutycycle", Controller.uPred[0,1])

        ## Publish controls ##
        cmd_servo = -1*Controller.uPred[0,0]
        cmd_motor = Controller.uPred[0,1]
        dutycycle_commands.publish(Controller.uPred[0,1])
        steering_commands.publish(-1*Controller.uPred[0,0])
